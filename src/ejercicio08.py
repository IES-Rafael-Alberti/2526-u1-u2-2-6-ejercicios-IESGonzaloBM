...
def validar_contrasena(contrasena: str) -> tuple[bool, int, int, int, int, int]:
    ...
    tiene_longitud = 0; tiene_mayuscula = 0; tiene_digito = 0; tiene_especial = 0; tiene_minuscula = 0

    if len(contrasena) >= 8:
        tiene_longitud = 1

    for digit in contrasena:
        if digit.isupper():
            tiene_mayuscula = 1
        if digit.islower():
            tiene_minuscula = 1
    ...
    es_valida = True if tiene_longitud == 1 and tiene_mayuscula == 1 and tiene_digito == 1 and tiene_especial == 1 and tiene_minuscula == 1 else False
